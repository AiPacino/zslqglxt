...
var
  XkDataInit: TXkDataInit;

implementation

{$R *.dfm}

procedure TXkDataInit.btn_AddClick(Sender: TObject);
begin
//  vl_Field.Strings[vl_Field.]
end;

procedure TXkDataInit.btn_AutoClick(Sender: TObject);
var
  i,iCount: Integer;
  sTitle,sKey:String;
begin
...
procedure TXkDataInit.btn_ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TXkDataInit.btn_ImportClick(Sender: TObject);
var
...
procedure TXkDataInit.btn_OpenClick(Sender: TObject);
var
...
procedure TXkDataInit.btn_StopClick(Sender: TObject);
begin
...
procedure TXkDataInit.cbb_TbClick(Sender: TObject);
begin
  if cbb_Tb.Text<>'' then
    Init_Source;
end;

procedure TXkDataInit.adoDataSet2ReconcileError(
...
procedure TXkDataInit.DeleteKsRecord;
//var
//  sID:string;
begin
...
procedure TXkDataInit.edt_ExcelChange(Sender: TObject);
begin
  cbb_Tb.Enabled := edt_Excel.Text<>'';
end;

procedure TXkDataInit.FormClose(Sender: TObject;
...
procedure TXkDataInit.FormCreate(Sender: TObject);
begin
  sField := TStringList.Create;
  Init_Desc;
end;

procedure TXkDataInit.FormDestroy(Sender: TObject);
begin
  sField.Free;
end;

function TXkDataInit.GetRecordCount: Integer;
begin
  Result := ADOConnection1.Execute('select count(*) from ['+cbb_Tb.Text+']').Fields[0].Value;
end;

procedure TXkDataInit.Init_Desc;
var
  i:integer;
  tfn:string;
begin
...
procedure TXkDataInit.Init_DescData(const sf,kdmc,Yx,sData: string);
begin
{
  fSf := sf;
  fKdmc := kdmc;
...
procedure TXkDataInit.Init_Source;
var
  i:integer;
begin
  with AdoDataSet1 do
...
procedure TXkDataInit.vl_FieldGetPickList(Sender: TObject;
