...
procedure TKsLqtzsPrint.RzGroup2Items0Click(Sender: TObject);
var
  path,fn :string;
begin
{
...
procedure TKsLqtzsPrint.RzGroup4Items1Click(Sender: TObject);
begin
  Close;
end;

procedure TKsLqtzsPrint.RzGroup3Items0Click(Sender: TObject);
begin
  //frm_PrintLqtzs.ShowModal;
end;

procedure TKsLqtzsPrint.mmi_ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TKsLqtzsPrint.mmi_PrnLQTZSClick(Sender: TObject);
var
...
procedure TKsLqtzsPrint.mmi_PrnLQKSMDClick(Sender: TObject);
var
  cds_Temp:TClientDataSet;
begin
  cds_Temp := TClientDataSet.Create(nil);
...
procedure TKsLqtzsPrint.mmi_ExcelClick(Sender: TObject);
begin
  ExportToExcel(3);
end;
...
begin
  ...
  begin
    if pim_AllowPrintNotEndKs.Checked then
      FillData(xlcc,sf,pc,lb,kl,zydm,zy,zygfm,ClientDataSet1,'已安排专业录取信息表')
    else
      FillData(xlcc,sf,pc,lb,kl,zydm,zy,zygfm,ClientDataSet1,'录取信息表');
...
procedure TKsLqtzsPrint.mmi_ExecSQLClick(Sender: TObject);
begin
  //Tfrm_SqlExecute.Create(Application).Show;
end;

procedure TKsLqtzsPrint.cbb_XlCcChange(Sender: TObject);
begin
...
procedure TKsLqtzsPrint.chk2Click(Sender: TObject);
begin
  Open_Access_Table();
end;

procedure TKsLqtzsPrint.btn_OKClick(Sender: TObject);
begin
  Open_Access_Table;
...
procedure TKsLqtzsPrint.btn_RefreshClick(Sender: TObject);
begin
  Open_Access_Table();
end;

procedure TKsLqtzsPrint.btn_SaveClick(Sender: TObject);
begin
...
procedure TKsLqtzsPrint.btn_SqlWhereClick(Sender: TObject);
begin
  if GetSqlWhere(ClientDataSet1,sWhereList) then
    Open_Access_Table(sWhereList.Text);
end;

procedure TKsLqtzsPrint.FormCreate(Sender: TObject);
var
  path,fn :string;
  sList:TStrings;
  ii:Integer;
...
procedure TKsLqtzsPrint.FormDestroy(Sender: TObject);
begin
  FreeAndNil(aForm);
  FreeAndNil(StuInfo);
...
procedure TKsLqtzsPrint.Open_Access_Table(const sWhere:string='');
var
...
procedure TKsLqtzsPrint.ds_AccessDataChange(Sender: TObject; Field: TField);
begin
  lbl1.Caption := '记录：'+IntToStr(ClientDataSet1.RecNo)+'/'+IntToStr(ClientDataSet1.RecordCount);
end;

procedure TKsLqtzsPrint.chk_FilterClick(Sender: TObject);
begin
  DBGridEH1.STFilter.Visible := chk_Filter.Checked;
end;

procedure TKsLqtzsPrint.chk_NotJxClick(Sender: TObject);
begin
  btn_OK.Click;
end;

procedure TKsLqtzsPrint.chk_ZyNoSameClick(Sender: TObject);
begin
  ClientDataSet1.Filtered := chk_ZyNoSame.Checked;
end;

procedure TKsLqtzsPrint.chk_ZyNotSameClick(Sender: TObject);
begin
  //ClientDataSet1.Filtered := chk_ZyNotSame.Checked;
end;

procedure TKsLqtzsPrint.ClientDataSet1AfterOpen(DataSet: TDataSet);
begin
  RealseSortedIcon(DBGridEH1);
end;

procedure TKsLqtzsPrint.ClientDataSet1FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TKsLqtzsPrint.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TKsLqtzsPrint.mmi_PrnEMSClick(Sender: TObject);
var
  cds_Temp:TClientDataSet;
begin
  cds_Temp := TClientDataSet.Create(nil);
...
procedure TKsLqtzsPrint.rg1Click(Sender: TObject);
begin
{
...
procedure TKsLqtzsPrint.UpDownNumEdit1Change(Sender: TObject);
begin
  //frxDBDataset1.RangeEndCount := UpDownNumEdit1.Value;
end;

procedure TKsLqtzsPrint.rg2Click(Sender: TObject);
begin
  Open_Access_Table;
end;

procedure TKsLqtzsPrint.Print_EMS(const designed: Boolean);
begin
end;

procedure TKsLqtzsPrint.Print_LQKSMD(const designed: Boolean);
begin
end;

procedure TKsLqtzsPrint.Print_LQTZS(const designed: Boolean);
begin
end;

procedure TKsLqtzsPrint.mmi_DesEMSClick(Sender: TObject);
begin
  Print_EMS(True);
end;

procedure TKsLqtzsPrint.mmi_DesLQTZSClick(Sender: TObject);
begin
  Print_LQTZS(True);
end;

procedure TKsLqtzsPrint.mmi_DesLQKSMDClick(Sender: TObject);
begin
  Print_LQKSMD(True);
end;

procedure TKsLqtzsPrint.mi_FormatKLClick(Sender: TObject);
var
...
procedure TKsLqtzsPrint.mmi_AllowEditClick(Sender: TObject);
begin
...
procedure TKsLqtzsPrint.pmi_CancelEndClick(Sender: TObject);
var
  sqlstr:string;
begin
...
procedure TKsLqtzsPrint.pmi_CardClick(Sender: TObject);
begin
  ExportToExcel(0);
end;

procedure TKsLqtzsPrint.pmi_EMSClick(Sender: TObject);
begin
  ExportToExcel(1);
end;

procedure TKsLqtzsPrint.pmi_JwxtClick(Sender: TObject);
begin
  ExportToExcel(2);
end;

procedure TKsLqtzsPrint.pmi_RefreshClick(Sender: TObject);
begin
  Open_Access_Table;
end;

procedure TKsLqtzsPrint.pmi_SetTdClick(Sender: TObject);
var
  sqlstr:string;
begin
...
procedure TKsLqtzsPrint.mmi_BHClick(Sender: TObject);
var
...
procedure TKsLqtzsPrint.dxDBMemo1DblClick(Sender: TObject);
begin
{
...
procedure TKsLqtzsPrint.DBGridEH1DblClick(Sender: TObject);
begin
...
procedure TKsLqtzsPrint.DBGridEH1DrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumnEh; State: TGridDrawState);
var
  zy1,zy2:string;
  iLen,iKszt:Integer;
...
function TKsLqtzsPrint.GetOrderString: string;
begin
end;

procedure TKsLqtzsPrint.GetWhereList;
var
  sTemp :string;
begin
  sWhereList.Clear;
...
procedure TKsLqtzsPrint.DBGridEH1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if vsorted then
    Open_Access_Table;
...
procedure TKsLqtzsPrint.DBGridEH1TitleClick(Column: TColumnEh);
begin
...
procedure TKsLqtzsPrint.edt1Change(Sender: TObject);
begin       
 // ClientDataSet1.Filtered := False;
 // ClientDataSet1.Filtered := (Length(edt1.Text)>=4) and chk1.Checked;
end;

procedure TKsLqtzsPrint.ExportToExcel(const iType: Integer);
var
...
procedure TKsLqtzsPrint.cbb_CompareChange(Sender: TObject);
begin
  cbb_Value.Enabled := (cbb_Compare.ItemIndex<>7) and (cbb_Compare.ItemIndex<>8);
end;

procedure TKsLqtzsPrint.cbb_ValueChange(Sender: TObject);
begin
...
procedure TKsLqtzsPrint.cbb_ValueKeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 then
    btn_OK.Click;
end;

function TKsLqtzsPrint.GetFilterString: String;
var
...
function TKsLqtzsPrint.GetMaxNo(const Sf, Lb: string): string;
var
  sKsh,sMsg,sqlstr:string;
  cds_Temp:TClientDataSet;
begin
...
function TKsLqtzsPrint.GetXznxString: String;
begin
end;

procedure TKsLqtzsPrint.mmi_ProcessSJRClick(Sender: TObject);
var
  sqlstr:string;
  updateCount:Integer;
begin
...
procedure TKsLqtzsPrint.mni_FormatKLClick(Sender: TObject);
var
  sf,pc,kl:string;
//  bm:TBookmark;
begin
...
procedure TKsLqtzsPrint.mni_SfClick(Sender: TObject);
begin
...
procedure TKsLqtzsPrint.N9Click(Sender: TObject);
var
  sqlstr:string;
  updateCount:Integer;
begin
