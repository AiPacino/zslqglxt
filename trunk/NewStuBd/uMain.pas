...
procedure TMain.act_Data_ZdMcSetExecute(Sender: TObject);
begin
  ShowMdiChildForm(TZdmcSet);
end;
...
procedure TMain.act_Lq_LqtzsPrintExecute(Sender: TObject);
begin
  ShowMdiChildForm(TKsLqtzsPrint);
end;
...
begin
  ...
  if gb_System_Mode<>'录取' then Exit;
