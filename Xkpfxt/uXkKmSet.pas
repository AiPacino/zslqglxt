...
begin
  ...
  begin
    ...
    sqlstr := 'delete from 成绩录入设置表 where 录入院系='+quotedstr(yx)+' and 录入科目='+quotedstr(km);
    sqlstr1 := 'delete from 校考专业科目设置表 where 承考院系='+quotedstr(yx)+' and 考试科目='+quotedstr(km);
...
begin
  if DataSetNoSave(ClientDataSet1) then
    if dm.UpdateData('Id','select * from 校考科目表',ClientDataSet1.Delta) then
