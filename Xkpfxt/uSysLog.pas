...
begin
  if gb_Czy_Level='-1' then
    ...
    sqlstr := ' where 用户='+quotedstr(gb_Czy_ID);
  sqlstr := 'select * from 操作日志表 '+sqlstr+sWhere+' order by ActionTime desc';
