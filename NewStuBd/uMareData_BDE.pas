...
procedure TMareData_BDE.SelectSf(const iType: Integer);
var
  i:Integer;
begin
...
procedure TMareData_BDE.SetState;
var
  i: Integer;
begin
  for i := 0 to chklst_Sf.Items.Count - 1 do
...
procedure TMareData_BDE.SpeedButton1Click(Sender: TObject);
//var
//  Dir: string;
begin
{
...
procedure TMareData_BDE.btn_ExitClick(Sender: TObject);
begin
  Close;
end;

function TMareData_BDE.Init_Con_BDE(const sDir: string):Boolean;
begin
  Close_Con_BDE;
...
procedure TMareData_BDE.InitSfDirList;
var
  sPath: string;
  i: Integer;
begin
...
procedure TMareData_BDE.btn_OKClick(Sender: TObject);
var
...
procedure TMareData_BDE.btn_StartClick(Sender: TObject);
var
...
procedure TMareData_BDE.FormCreate(Sender: TObject);
var
  sList:TStrings;
begin
...
procedure TMareData_BDE.LabeledEdit1Change(Sender: TObject);
begin
  //btn_OK.Enabled := LabeledEdit1.Text<>'';
end;

procedure TMareData_BDE.mni_Select2Click(Sender: TObject);
begin
  SelectSf(TMenuItem(Sender).Tag);
  SetState;
end;

procedure TMareData_BDE.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  myIniFile.Free;
  Action := caFree;
end;

procedure TMareData_BDE.cds_lqmdBeforePost(DataSet: TDataSet);
var
  zymc:string;
begin
...
procedure TMareData_BDE.chk1Click(Sender: TObject);
begin
  if chk1.Checked then
  begin
...
procedure TMareData_BDE.chklst_SfChange(Sender: TObject; Index: Integer;
  NewState: TCheckBoxState);
begin
  SetState;
end;
...
procedure TMareData_BDE.btn_CjClick(Sender: TObject);
{
var
...
function TMareData_BDE.GetEnglishCjdm: string;
//var
//  vv:Variant;
begin
{
...
function TMareData_BDE.Get_JHK_Zymc(const pcdm, kldm, jhxz, tddw,
...
function TMareData_BDE.Get_TDD_Count(const sXlcc: string): Integer;
var
  sqlstr:string;
begin
  try
...
function TMareData_BDE.Get_TDD_SfDm(const sfmc:string=''): string;
var
  sqlstr:string;
begin
  try
