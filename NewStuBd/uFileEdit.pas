...
procedure TFileEdit.btn_SaveAsClick(Sender: TObject);
begin
...
procedure TFileEdit.btn_SaveClick(Sender: TObject);
begin
...
procedure TFileEdit.btn_AddClick(Sender: TObject);
begin
  ClientDataSet1.Append;
end;

procedure TFileEdit.btn_CancelClick(Sender: TObject);
begin
  ClientDataSet1.Cancel;
end;

procedure TFileEdit.btn_DelClick(Sender: TObject);
begin
...
procedure TFileEdit.btn_ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TFileEdit.btn_OpenClick(Sender: TObject);
begin
...
procedure TFileEdit.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFileEdit.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  if DataSetNoSave(ClientDataSet1) then
...
procedure TFileEdit.FormCreate(Sender: TObject);
begin
